...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-11-2022 a las 23:40:57
...
(18, '1', 'Maria Rosas Villanueva', 'Los Laureles', '1'),
(37, '23123', 'David Lozada editado', 'La carabobo', '1');
...
(12, '123', 'Edmanuel Vera', '21312', '1', 'Edma'),
(43, '123', 'Leonel Messi', '555555', '1', 'Messi'),
(47, '123', 'Nelson Mandela ESTE EDIT', '042134', '1', 'Dios');
...
(1, 18, 12, '00000021', '2020-12-12', 231, '1');
...
--
ALTER TABLE `cliente`
  MODIFY `IdCliente` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;

--
-- AUTO_INCREMENT de la tabla `detalle_ventas`
--
ALTER TABLE `detalle_ventas`
  MODIFY `IdDetalleVentas` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=200;

--
-- AUTO_INCREMENT de la tabla `empleado`
--
ALTER TABLE `empleado`
  MODIFY `IdEmpleado` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;

--
-- AUTO_INCREMENT de la tabla `producto`
--
ALTER TABLE `producto`
  MODIFY `IdProducto` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
